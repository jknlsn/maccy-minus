...
extension Defaults.Keys {
  ...
  static let deduplicateStrings = Key<Bool>("deduplicateStrings", default: false)
  ...
  static let alwaysUseFoundationModels = Key<Bool>("alwaysUseFoundationModels", default: false)
}
